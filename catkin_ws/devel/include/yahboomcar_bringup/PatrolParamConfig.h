...
namespace yahboomcar_bringup
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PatrolParamConfig &config, const PatrolParamConfig &max, const PatrolParamConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PatrolParamConfig &config1, const PatrolParamConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PatrolParamConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PatrolParamConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PatrolParamConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PatrolParamConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PatrolParamConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PatrolParamConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PatrolParamConfig::AbstractParamDescriptionConstPtr(new PatrolParamConfig::ParamDescription<int>("Command", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'LengthTest', 'type': 'int', 'value': 0, 'srcline': 18, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'first data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AngleTest', 'type': 'int', 'value': 1, 'srcline': 19, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'two data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Triangle', 'type': 'int', 'value': 2, 'srcline': 20, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'three datat', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Square', 'type': 'int', 'value': 3, 'srcline': 21, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'four data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Circle', 'type': 'int', 'value': 4, 'srcline': 22, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'five data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Parallelogram', 'type': 'int', 'value': 5, 'srcline': 23, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'six data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &PatrolParamConfig::Command)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 18 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_LengthTest = 0;
//#line 19 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_AngleTest = 1;
//#line 20 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Triangle = 2;
//#line 21 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Square = 3;
//#line 22 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Circle = 4;
//#line 23 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/PatrolParam.cfg"
