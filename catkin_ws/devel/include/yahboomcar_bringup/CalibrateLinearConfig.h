...
namespace yahboomcar_bringup
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CalibrateLinearConfig &config, const CalibrateLinearConfig &max, const CalibrateLinearConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CalibrateLinearConfig &config1, const CalibrateLinearConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CalibrateLinearConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CalibrateLinearConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CalibrateLinearConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CalibrateLinearConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CalibrateLinearConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CalibrateLinearConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateLinearConfig::AbstractParamDescriptionConstPtr(new CalibrateLinearConfig::ParamDescription<int>("direction", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Y', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/CalibrateLinear.cfg', 'description': 'first data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'X', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/CalibrateLinear.cfg', 'description': 'two data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &CalibrateLinearConfig::direction)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/cannot/catkin_ws/src/navigation_Yh/yahboomcar_bringup/cfg/CalibrateLinear.cfg"
